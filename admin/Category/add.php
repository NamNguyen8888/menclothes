<?php
  ...
  if(!empty($_POST)) {
    ...
    if(!empty($Category)) {
      ...
      if($IdCategory == '') {
        $sql = 'insert into category( Category,Create_at, Update_at) values("'.$Category.'", "'.$create_at.'", "'.$update_at.'") ';
      }
      else {
        $sql = 'update category set Category = "'.$Category.'", update_at = "'.$update_at.'" where IdCategory = '.$IdCategory;
      }
      execute($sql);
                ...
                <main>
                    <div class="container-fluid px-4">
                      ...
                      <form action="" method="post"  >
                        <div class="col-xl-6">
                          <input type="text" class="form-control mb-4" name="IdCategory" id="IdCategory" value="<?=$IdCategory?>" hidden="true">
                          <label for="" class="mb-2">Category Name</label>
                          <input type="text" class="form-control mb-4" name="Category" id="Category" value="<?=$Category?>" >
