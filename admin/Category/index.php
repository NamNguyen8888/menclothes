                                            ...
                                            foreach($categoryList as $item) {
                                              echo '
                                                <tr>
                                                  ...
                                                  <td> <a href="add.php?IdCategory='.$item['IdCategory'].'" ><button class="btn btn-warning">Edit</button></a> </td>
                                                
                                                  <td><button class="btn btn-danger" onclick="deleteCategory('.$item['IdCategory'].')">Delete</button></td>
                                                </tr>  
                                              ';
                                            }
                                          ?>
